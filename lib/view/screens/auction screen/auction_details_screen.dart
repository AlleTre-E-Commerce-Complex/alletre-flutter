                      ...
                      builder: (context, value, child) {
                        return Column(
                          children: [
                              ...
                              children: [
                                Radio<String>(
                                  ...
                                  onChanged: (selected) {
                                    ...
                                    selectedDuration.value = null; // Reset dropdown
                                  },
                                ),
                                const Column(
                            ...
                            SwitchWithField(
                              label: 'Schedule Bid',
                              leadingText: 'If a start date and time are not chosen,\nyour listing becomes active immediately',
                            ...
                            TextFormField(
                              ...
                              validator: CreateAuctionValidation.validatePrice,
                            ),
                            const SizedBox(height: 22),
                            // Buy Now Logic
                            SwitchWithField(
                              label: 'Buy Now',
                              leadingText: 'Amount the user should pay to buy\nthe item directly without auction',
                            ...
                            SwitchWithField(
                              label: 'Return Policy',
                              leadingText: 'Write your own return related policy here',
