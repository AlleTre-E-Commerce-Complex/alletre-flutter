                      ...
                      child: ValueListenableBuilder<Map<String, String>>(
                        ...
                        builder: (context, selected, _) {
                          if (context.watch<LoggedInProvider>().isLoggedIn == true) {
                            provider.getJoinedAuctions(_selectedType.value.keys.first);
                          }
                          return DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              value: selected.values.first,
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        debugPrint(auction.product!['title']);
                        return Card(
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Start: ${auction.currentBid} AED", style: const TextStyle(color: Colors.grey)),
                                      Text(
                                        "Ends in: ${_formatRemainingTime(auction.expiryDate)}",
